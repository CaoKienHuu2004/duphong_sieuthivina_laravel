        ...
        <div class="col-lg-6 w-100">
          <div class="banner-two-wrapper d-flex align-items-start">
            <div
              ...
              <div class="flex-align">
                <button type="button" id="banner-mobile-prev" class="slick-prev flex-center rounded-circle bg-white text-xl hover-bg-main-600 hover-text-white transition-1 slick-arrow">
                  <i class="ph-bold ph-caret-left"></i>
                </button>
                <button type="button" id="banner-mobile-next" class="slick-next flex-center rounded-circle bg-white text-xl hover-bg-main-600 hover-text-white transition-1 slick-arrow">
                  <i class="ph-bold ph-caret-right"></i>
                </button>
              </div>
              ...
              <div class="banner-item-mobile__slider">
                @if(isset($sliderBanner) && $sliderBanner->isNotEmpty())
                  @foreach ($sliderBanner as $banner)
                    <a href="{{ $banner->lienket }}" class="d-flex align-items-center justify-content-between flex-wrap-reverse flex-sm-nowrap gap-32 w-100">
                    <img src="{{asset('assets/client')}}/images/bg/{{ $banner->hinhanh }}" alt="{{ $banner->hinhanh }}" class=" d-block d-lg-none rounded-5" style="width: 100%; height: 300px; object-fit: cover;" />
                  </a>
                  @endforeach
                @else
        ...
        <div class="feature-item-mobile-wrapper">
          @foreach ($alldanhmuc as $dsdm)
            <div class="feature-item text-center wow bounceIn" data-aos="fade-up" data-aos-duration="400">
              ...
              <div class="feature-item__content mt-16">
                <h6 class="text-xs fw-medium mb-8"><a href="{{ url('san-pham?danhmuc=' . $dsdm->slug) }}" class="text-inherit">{{ $dsdm->ten }}</a></h6>
              </div>
            </div>
          @endforeach
      ...
      <div class="pr-20 py-16 px-0 bg-hotsales">
        <div class="section-heading mb-24 px-10">
          <div class="flex-between gap-8">
            <h6 class="mb-0 wow fadeInLeft text-white">
              <img src="{{asset('assets/client')}}/images/thumbs/top-deal-sieu-re.png" alt="" class="py-10 d-lg-none d-block" width="75%">
            </h6>
            <div class="flex-align gap-16 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
              <div class="flex-align gap-4">
              ...
              @foreach ($topdeals as $td)
                ...
                <div
                  ...
                  <a href="{{ route('chi-tiet-san-pham', $td->slug) }}" class="thumbhover flex-center rounded-10 position-relative bg-gray-50 w-100">
                    ...
                    @endif
                    <div class="w-100">
                      <img src="{{asset('assets/client')}}/images/thumbs/{{ $td->hinhanhsanpham->first()->hinhanh }}" alt="{{ $td->hinhanhsanpham->first()->hinhanh }}" class="" style="width: 100%; height: 150px; object-fit: cover; border-top-left-radius:10px; border-top-right-radius:10px;" />
                    </div>
                  </a>
                  <div class="product-card__content w-100 px-12 pb-16 mt-5">
                    ...
                    <div class="flex-wrap flex-align justify-content-between mt-5">
                      <div class="flex-align gap-6">
                        <span class="text-xs fw-medium text-gray-500 flex-align gap-4"><i class="ph-fill ph-star text-warning-600 text-sm "></i> 4,7 (12)</span>
                      </div>
                      <div class="flex-align gap-4">
                        <span class="text-xs fw-medium text-gray-500">Đã bán</span>
                        <span class="text-xs fw-medium text-gray-500">{{ $td->bienthe_sum_luotban }}</span>
        ...
        <div class="">
            <div class="section-heading mb-24">
                <div class="flex-between flex-align gap-4 w-100">
                    ...
                    <div class="flex-align gap-16 wow fadeInRight">
                        <div class="flex-align gap-8">
                            <button type="button" id="gift-event-mobile-prev" class="slick-prev slick-arrow flex-center rounded-circle border border-gray-100 hover-border-main-600 text-xl hover-bg-main-600 hover-text-white transition-1" >
                                <i class="ph ph-caret-left"></i>
                            </button>
                            <button type="button" id="gift-event-mobile-next" class="slick-next slick-arrow flex-center rounded-circle border border-gray-100 hover-border-main-600 text-xl hover-bg-main-600 hover-text-white transition-1" >
                                <i class="ph ph-caret-right"></i>
                            </button>
                        </div>
                    </div>
    ...
    <div class="container container-lg">
      <div class="border border-gray-100 py-24 px-10 rounded-8">
              ...
              @if($danhsachdmhangdau->isNotEmpty())
                @foreach($danhsachdmhangdau as $key => $danhmuc)
                  <li class="nav-item" role="presentation">
                    <button 
                        class="nav-link fw-medium text-sm hover-border-main-600 {{$loop->first ? 'active' : '' }}" 
                        id="tab-{{ $danhmuc->id }}-mobile" 
                        data-bs-toggle="pill" 
                        data-bs-target="#content-{{ $danhmuc->id }}-mobile" 
                        type="button" 
                        role="tab" 
                        aria-controls="content-{{ $danhmuc->id }}-mobile" 
                        aria-selected="{{ $key == 0 ? 'true' : 'false' }}">
                      {{ $danhmuc->ten}}
                    </button>
                  </li>
        ...
        <div class="tab-content" id="pills-tabContent">
          @if($sanphamthuocdanhmuc->isNotEmpty())
            @foreach ($sanphamthuocdanhmuc as $categoryId => $products)
              <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="content-{{ $categoryId }}-mobile" role="tabpanel" aria-labelledby="tab-{{ $categoryId }}-mobile" tabindex="0">
                <div class="row g-12">
                  @foreach ($products as $product)
                      <div class="col-xxl-2 col-xl-3 col-lg-4 col-xs-6">
                        <div class="product-card h-100 border border-gray-100 hover-border-main-600 rounded-6 position-relative transition-2">
            ...
            <div class="top-brand-slider arrow-style-two">
              @if ($topbrands->isNotEmpty())
                ...
                <div data-aos="fade-up" data-aos-duration="200">
                  <div class="product-card hover-card-shadows h-100 p-5 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2 bg-white justify-content-center">
                    <a href="{{ $topbrand->slug }}" class="product-card__thumb flex-center rounded-8 position-relative" style="height: 120px;">
                      <img src="{{asset('assets/client')}}/images/brands/{{ $topbrand->logo }}" alt="{{ $topbrand->logo }}" class="object-fit-cover" style="width: 50%;" />
                    </a>
                  </div>
                </div>
                @endforeach
  ...
  <section class="sanphamhangdau pt-20 overflow-hidden fix-scale-30 pb-40 ">
    <div class="container container-lg px-0">
      <div class="pr-20 py-16 px-0">
        <div class="section-heading mb-24 px-10">
          <div class="flex-between flex-wrap gap-2">
                <h6 class="mb-0 wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;"><i class="ph-bold ph-package text-main-600"></i> Sản phẩm hàng đầu</h6>
                <div class="flex-align gap-16 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                  <div class="flex-align gap-8">
                    <button type="button" id="sphd-prev" class="slick-prev slick-arrow flex-center rounded-circle border border-gray-100 hover-border-neutral-600 text-xl hover-bg-neutral-600 hover-text-white transition-1">
                      <i class="ph ph-caret-left"></i>
                    </button>
                    <button type="button" id="sphd-next" class="slick-next slick-arrow flex-center rounded-circle border border-gray-100 hover-border-neutral-600 text-xl hover-bg-neutral-600 hover-text-white transition-1">
                      <i class="ph ph-caret-right"></i>
                    </button>
                  </div>
                </div>
