                                            ...
                                            <div class="">
                                                <div class="product-details__thumb flex-center h-100">
                                                    <img class=" rounded-10"
                                                        src="{{asset('assets/client')}}/images/thumbs/{{ $hasp->hinhanh }}"
                                                        alt=""
                            ...
                            <div class="col-xl-6">
                                <div class="product-details__content">
                                    ...
                                    {{-- <div
                                        ...
                                        <img src="{{asset('assets/client')}}/images/bg/details-offer-bg.png" alt=""
                                            class="position-absolute inset-block-start-0 inset-inline-start-0 rounded-8 h-100  z-n1 object-fit-cover">
                                    ...
                                    <div class="flex-align flex-wrap gap-12">
                                        @foreach ($sanpham->danhmuc as $dm)
                                            <a href="{{ url('san-pham?danhmuc=' . $dm->slug) }}"
                                                class="btn btn-main rounded-8 py-6 px-8 text-sm">{{ $dm->ten }}</a>
                                        @endforeach
                                    ...
                                    <div class="flex-align flex-wrap gap-12 mt-10">
                                        <div class="flex-align gap-4 flex-wrap">
                                            <div class="flex-align gap-8">
                                                <span class="text-xl fw-medium text-warning-600 d-flex"><i
                                        ...
                                        @if($sanpham->bienthe->sum('luotban') > 0)
                                            ...
                                            <div class="flex-align gap-8">
                                                ...
                                                <span
                                                    class="text-md fw-medium text-gray-500">{{ $sanpham->bienthe->sum('luotban') }}</span>
                                            </div>
                                        @endif
                                    ...
                                    <div class="mb-32 flex-align gap-16 flex-wrap">
                                        <div class="flex-align gap-8">
                                            ...
                                            <h6 class="mb-0 text-main-600 text-2xl @if($initialVariant && !$initialVariant->is_sale) mt-30 @endif"
                                                id="current-price">
                                                @if($initialVariant)
                                        ...
                                        @if($initialVariant && $initialVariant->is_sale)
                                            <div class="flex-align gap-8">
                                                ...
                                                <h6 class="text-xl text-gray-400 mb-0 fw-medium text-decoration-line-through"
                                                    id="original-price">
                                                    {{  number_format($sanpham->bienthe->first()->giagoc, 0, ',', '.')}} ₫
                                                </h6>
                                            </div>
                                        @endif
                                    </div>
                                                ...
                                                <div class=" flex-align gap-8">
                                                    @foreach($sanpham->bienthe as $bienthe)
                                                        <input type="radio" @if($loop->first) checked @endif
                                                            id="bienthe-{{ $bienthe->id }}" name="id_bienthe"
                                                            value="{{ $bienthe->id }}" class="d-none"
                                                            data-variant-id="{{ $bienthe->id }}" onclick="updatePrice(this)">
                                    ...
                                    {{-- <span class="mt-32 text-gray-700 border-top border-gray-100 d-block"></span> --}}
                                    @if($danhSachQuaTang->isNotEmpty())
                                        <div class="bg-gray-50 rounded-8 mt-22">
                                            <div class="d-flex align-items-center gap-8">
                                                <a href="{{ route('chi-tiet-qua-tang',$danhSachQuaTang->first()->slug) }}" class="border border-gray-100 rounded-start-2 flex-center"
                                                    style="max-width: 150px; max-height: 150px; width: 100%; height: 100%">
                                                    <img src="{{asset('assets/client')}}/images/thumbs/{{ $danhSachQuaTang->first()->hinhanh }}"
                                                        alt="{{ $danhSachQuaTang->first()->hinhanh }}"
                                                        class="w-100 rounded-start-2">
                                                </a>
                                                <div class="text-start my-10 me-4">
                                                    <h6 class="title text-md fw-semibold mb-0 flex-align gap-4">
                                                        <i class="ph-bold ph-gift text-main-600 text-2xl"></i>
                                                        <a href="{{ route('chi-tiet-qua-tang',$danhSachQuaTang->first()->slug) }}"
                                                            class="link text-line-2 text-md"
                                                            title="Nước Yến sào Wellmune Nest100 Kids – Nâng cao đề kháng (6 lọ)"
                                                            style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: 331px; display: inline-block;">{{ $danhSachQuaTang->first()->tieude }}</a>
                                                    </h6>
                                                    <div class="flex-align gap-16 mb-2">
                                                        <a href="{{ route('chi-tiet-qua-tang',$danhSachQuaTang->first()->slug) }}"
                                                            class=" text-heading text-sm py-4 px-0 rounded-8 flex-center gap-8 fw-normal">
                                                            {{ $danhSachQuaTang->first()->thongtin }}
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="product-details__sidebar py-40 px-32 border border-gray-100 rounded-16">
                            ...
                            <div class="mb-20">
                                ...
                                <div class="d-flex rounded-4 overflow-hidden">
                                    ...
                                    <input type="number" id="quantity-input" value="1" min="1" name="soluong"
                            ...
                            <button type="submit"
                                class="btn btn-main flex-center gap-8 rounded-8 py-16 fw-normal mt-10 w-100">
                                <i class="ph ph-shopping-cart-simple text-lg"></i>
                                Thêm vào giỏ hàng
                            </button>

                            <div class="mt-32">
                                <a href="{{ url('san-pham?thuonghieu=' . $sanpham->thuonghieu->slug) }}"
                                    ...
                                    <span
                                        ...
                                        <img src="{{ asset('assets/client') }}/images/brands/{{ $sanpham->thuonghieu->logo }}"
                                            alt="{{ $sanpham->thuonghieu->ten }}" class="w-100">
                                    </span>
                                    <span class="text-sm text-neutral-600"><span
                                            class="fw-semibold">{{ $sanpham->thuonghieu->ten }}</span> </span>
                                </a>
                            </div>
                    ...
                    <div class="product-dContent border rounded-24">
                            ...
                            <ul class="nav common-tab nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="pills-description-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-description" aria-selected="true">Mô tả sản phẩm</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-reviews-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-reviews" type="button" role="tab"
                                        aria-controls="pills-reviews" aria-selected="false">Đánh giá</button>
                                </li>
                            </ul>
                        ...
                        <div class="product-dContent__box py-20">
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active text-black" id="pills-description" role="tabpanel"
                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            ...
                                            <div
                                                ...
                                                <img src="{{asset('assets/client')}}/images/thumbs/comment-img1.png" alt=""
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <p class="text-gray-700 mt-10">There are many variations of passages of
                                            ...
                                            {{-- <div class="mt-56">
                                                <div class="">
                                                    ...
                                                    <span class="text-heading mb-8">Bạn có hài lòng với sản phẩm này không
                                                        ?</span>
                                                    <div class="flex-align gap-8">
                                                ...
                                                <div class="mt-32">
                                                    <form action="#">
                                                        ...
                                                        <div class="mb-10">
                                                            ...
                                                            <textarea class="common-input rounded-8" id="desc"
                                                                placeholder="Nhập những dòng suy nghĩ của bạn..."></textarea>
                                                        </div>
                                                        <button type="submit" class="btn btn-main rounded-pill mt-20">Đăng
                                                            tải</button>
                                                    </form>
                                                </div>
                                            </div> --}}
                                    ...
                                    <div>
                                        <div class="flex-align justify-content-between mt-5">
                                            <div class="flex-align gap-4 w-100">
                                                ...
                                                <a href="{{ url('san-pham?thuonghieu=' . $product->thuonghieu->slug) }}"
                                                    class="text-gray-500 text-xs"
                                                    style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width:100%; display: inline-block;"
                                                    title="Trung Tâm Bán Hàng Siêu Thị Vina">Trung Tâm Bán Hàng Siêu Thị
                                                    Vina</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-align justify-content-between mt-2">
                                            ...
                                            <div class="flex-align gap-4">
                                                <span
                                                    class="text-xs fw-medium text-gray-500">{{ $product->bienthe_sum_luotban }}</span>
