                ...
                <div class="row gy-4">
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class="py-20 px-5">
                                                        <div class="d-flex rounded-4 overflow-hidden">
                                                            ...
                                                            <input type="number" class="quantity__input flex-grow-1 border border-gray-100 border-start-0 border-end-0 text-center w-32 px-4" value="{{ $cart->soluong }}" min="1">
                                                    ...
                                                    <td class="py-20 px-5">
                                                        <span class="text-lg h6 mb-0 fw-semibold text-main-600">{{ number_format($cart->thanhtien,0,',','.') }} đ</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="cart-sidebar border border-gray-100 rounded-8 px-24 py-30 pb-20">
                            ...
                            <div class="flex-align gap-16">
                                <input type="text" class="common-input p-10" placeholder="Nhập mã giảm giá..." value="SIEUTHIVINA">
                            </div>  
                            <a href="checkout.html" class="btn border-main-600 text-main-600 hover-bg-main-600 hover-text-white mt-20 py-10 w-100 rounded-8">Áp dụng</a>
                        </div>
                        <div class="cart-sidebar border border-gray-100 rounded-8 px-20 py-20 mt-20">
                            <div class="mb-20">
                                ...
                                <a href="#" class="text-sm text-gray-600 flex-align gap-1 fw-medium" style="cursor:pointer;">2 sản phẩm + 1 quà tặng</a>
                            </div>
