                ...
                <div class="row gy-5">
                    <div class="col-lg-8 pe-xl-4">
                        <div class="blog-item-wrapper">
                            <div class="blog-item">
                                <a href="blog-detials.html" class="w-100 h-100 rounded-16 overflow-hidden">
                                    <img src="{{asset('assets/client')}}/images/thumbs/blog-img1.png" alt="" class="cover-img">
                                </a>
                            ...
                            <div class="blog-item">
                                <a href="blog-detials.html" class="w-100 h-100 rounded-16 overflow-hidden">
                                    <img src="{{asset('assets/client')}}/images/thumbs/blog-img2.png" alt="" class="cover-img">
                                </a>
                                <div class="blog-item__content mt-24">
                                    <span class="bg-main-50 text-main-600 py-4 px-24 rounded-8 mb-16">Gadget</span>
                                    <h6 class="text-2xl mb-24">
                            ...
                            <div class="blog-item">
                                <a href="blog-detials.html" class="w-100 h-100 rounded-16 overflow-hidden">
                                    <img src="{{asset('assets/client')}}/images/thumbs/blog-img3.png" alt="" class="cover-img">
                                </a>
                                <div class="blog-item__content mt-24">
                                    <span class="bg-main-50 text-main-600 py-4 px-24 rounded-8 mb-16">Gadget</span>
                                    <h6 class="text-2xl mb-24">
                        ...
                        <div class="blog-sidebar border border-gray-100 rounded-8 p-32 mb-40">
                            ...
                            <div class="d-flex align-items-center flex-sm-nowrap flex-wrap gap-24 mb-16">
                                <a href="blog-details.html"
                                    ...
                                    <img src="{{asset('assets/client')}}/images/thumbs/recent-post1.png" alt="" class="cover-img">
                                </a>
                            ...
                            <div class="d-flex align-items-center flex-sm-nowrap flex-wrap gap-24 mb-16">
                                <a href="blog-details.html"
                                    class="w-100 h-100 rounded-4 overflow-hidden w-120 h-120 flex-shrink-0">
                                    <img src="{{asset('assets/client')}}/images/thumbs/recent-post2.png" alt="" class="cover-img">
                                </a>
                                <div class="flex-grow-1">
                                    <h6 class="text-lg">
                                        <a href="blog-details.html" class="text-line-3">Once determined you need to come up
                            ...
                            <div class="d-flex align-items-center flex-sm-nowrap flex-wrap gap-24 mb-16">
                                <a href="blog-details.html"
                                    class="w-100 h-100 rounded-4 overflow-hidden w-120 h-120 flex-shrink-0">
                                    <img src="{{asset('assets/client')}}/images/thumbs/recent-post3.png" alt="" class="cover-img">
                                </a>
                                <div class="flex-grow-1">
                                    <h6 class="text-lg">
                                        <a href="blog-details.html" class="text-line-3">Once determined you need to come up
                            ...
                            <div class="d-flex align-items-center flex-sm-nowrap flex-wrap gap-24 mb-0">
                                <a href="blog-details.html"
                                    class="w-100 h-100 rounded-4 overflow-hidden w-120 h-120 flex-shrink-0">
                                    <img src="{{asset('assets/client')}}/images/thumbs/recent-post4.png" alt="" class="cover-img">
                                </a>
                                <div class="flex-grow-1">
                                    <h6 class="text-lg">
                                        <a href="blog-details.html" class="text-line-3">Once determined you need to come up
