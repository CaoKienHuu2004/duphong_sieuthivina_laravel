...
@section('title')
    Sửa địa chỉ giao hàng | Siêu Thị Vina - Nền Tảng Bán Hàng Trực Tuyến Siêu Thị Vina
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <div class="flex-between gap-16 flex-wrap mb-20 ">
                            <h6 class="mb-0 text-gray-900">Chỉnh sửa địa chỉ giao hàng</h6>
                                    ...
                                    <div class="col-md-6 mb-24">
                                        ...
                                        <select class="placeholder-italic common-input py-11 px-14 text-sm" id="tinhthanh" name="tinhthanh">
                                            ...
                                            @foreach ($tinhThanhs as $tinh)
                                                <option value="{{ $tinh['name'] }}" {{ $diachi->tinhthanh == $tinh['name'] ? 'selected' : '' }}>{{ $tinh['name'] }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-24">
                                        <div class="form-check common-check">
                                            <input class="form-check-input" type="checkbox" id="default" name="trangthai" value="Mặc định" {{ $diachi->trangthai == 'Mặc định' ? 'checked' : '' }}>
