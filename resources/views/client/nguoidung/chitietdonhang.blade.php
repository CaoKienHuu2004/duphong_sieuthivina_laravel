                ...
                <div class="container container-lg">
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="flex-between gap-16 flex-wrap">
                                <h6 class="mb-20 text-gray-600 text-md fw-medium flex-align gap-12">Mã đơn: #STV25110910 <span class="bg-success-200 p-4 text-success-900 fw-semibold text-xs rounded-4">Đã giao hàng</span></h6>
                                <div class="flex-align gap-8 mb-20">
                                    <i class="ph-bold ph-clock-countdown text-gray-600 text-md"></i>
                                    <span class="text-gray-600 text-sm fw-normal"><span class="fw-medium">Ngày đặt hàng:</span> 25/11/2023 - 13:30</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 d-flex flex-column gap-5">
                                    <span class="text-md fw-semibold text-gray-900">Địa chỉ người nhận</span>
                                    <div class="border border-gray-300 rounded-4 py-10 px-10 h-100">
                                        <div class="text-sm fw-semibold text-gray-900">Cao Kiến Hựu</div>
                                        <div class="text-sm text-gray-800 mt-5"><span class="fw-medium">Địa chỉ:</span> ấp Trường An, Xã Trường Tây, Thị xã Hòa Thành, Tây Ninh</div>
                                        <div class="text-sm text-gray-800 mt-5"><span class="fw-medium">Số điện thoại:</span> 0987654321</div>
                                    </div>
                                </div>
                                <div class="col-lg-4 d-flex flex-column gap-5">
                                    <span class="text-md fw-semibold text-gray-900">Hình thức vận chuyển</span>
                                    <div class="border border-gray-300 rounded-4 py-10 px-10 h-100">
                                        <div class="text-sm fw-semibold text-gray-900">Giao hàng Ngoại tỉnh (Vùng lân cận khác)</div>
                                        <div class="text-sm text-gray-800 mt-5"><span class="fw-medium">Phí vận chuyển:</span> <span class="fst-italic">15.000 đ</span></div>
                                        <div class="text-sm text-gray-800 mt-5"><span class="fw-medium">Khu vực giao:</span> <span class="fst-italic">Tây Ninh</span></div>
                                    </div>
                                </div>
                                <div class="col-lg-4 d-flex flex-column gap-5">
                                    <span class="text-md fw-semibold text-gray-900">Hình thức thanh toán</span>
                                    <div class="border border-gray-300 rounded-4 py-10 px-10 h-100">
                                        <div class="text-sm fw-semibold text-gray-900">Thanh toán khi nhận hàng (COD)</div>
                                        <div class="text-sm text-gray-800 mt-5"><span class="fw-medium">Trạng thái:</span> <span class="fst-italic text-warning-600">Thanh toán khi nhận hàng</span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-20">
