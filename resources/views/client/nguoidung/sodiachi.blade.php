                            ...
                            <div class="border border-gray-100 rounded-8 p-16">
                                <div class="row gy-2">
                                        <div class="col-lg-12 col-xl-12">
                                            <form action="https://sieuthivina.com/thanh-toan/cap-nhat-mac-dinh" method="POST" class="border-dashed border-2 border-gray-200 text-main-900 rounded-4 px-20 py-16 mb-10">
                                                <input type="hidden" name="_token" value="mLorwkebNQLqLMZywmPUJnCIZaDF0DYjjO4IyizR" autocomplete="off">                            <div class="d-flex flex-align flex-between gap-24">
                                                    <div class="flex-align gap-12">
                                                        <span class="fw-semibold text-gray-900 text-md border-end border-gray-600 pe-10">Cao Kiến Hựu</span>
                                                        <span class="fw-semibold text-gray-900 text-md">0845381121</span>
                                                    </div>
                                                    <div class="flex-align gap-12">
                                                        <span class="fw-medium text-xs text-success-700 bg-success-100 px-6 py-2 rounded-4 flex-align gap-8">Mặc định</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex flex-align gap-24 pt-10">
                                                    <div class="flex-align gap-12">
                                                        <span class="fw-medium text-gray-900 text-sm">Địa chỉ: 29/7C, đường số 25-A1 Ngô Quyền, ấp Trường An, xã Trường Tây, thị xã Hòa Thành, Tây Ninh</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex flex-align gap-12 pt-10">
                                                    <div class="flex-align gap-12">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <form action="https://sieuthivina.com/thanh-toan/cap-nhat-mac-dinh" method="POST" class="border-dashed border-2 border-gray-200 text-main-900 rounded-4 px-20 py-16 mb-10">
                                                <input type="hidden" name="_token" value="mLorwkebNQLqLMZywmPUJnCIZaDF0DYjjO4IyizR" autocomplete="off">                            <div class="d-flex flex-align flex-between gap-24">
                                                    <div class="flex-align gap-12">
                                                        <span class="fw-semibold text-gray-900 text-md border-end border-gray-600 pe-10">Cao Vũ Nghị</span>
                                                        <span class="fw-semibold text-gray-900 text-md">0911975996</span>
                                                    </div>
                                                    <div class="flex-align gap-12">
                                                        <span class="fw-medium text-xs text-gray-700 bg-gray-100 px-6 py-2 rounded-4 flex-align gap-8">Khác</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex flex-align gap-24 pt-10">
                                                    <div class="flex-align gap-12">
                                                        <span class="fw-medium text-gray-900 text-sm">Địa chỉ: Tòa T - FPT Polytechnic csHCM, CVPM Quang Trung, phường Tân Chánh Hiệp, quận 12, TP.Hồ Chí Minh</span>
                                                    </div>
                                                </div>
                                                <div class="d-flex flex-align gap-12 pt-10">
                                                    <div class="flex-align gap-12">
                                                        <input type="hidden" name="id_diachi" value="2">
