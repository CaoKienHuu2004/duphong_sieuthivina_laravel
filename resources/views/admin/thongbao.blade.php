...
@section('title', 'Tạo banner quảng cáo | Quản trị hệ thống Siêu Thị Vina')

@section('content')
    <div class="page-wrapper">
        <form class="content" action="{{ route('quan-tri-vien.luu-banner-quang-cao') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="page-header">
                <div class="page-title">
                    <h4>Thêm banner quảng cáo</h4>
                    <h6>Thêm thông tin banner quảng cáo của bạn vào hệ thống</h6>
                </div>
                <div class="page-btn">
                    <button type="submit" class="btn btn-added"><img src="{{asset('assets/admin')}}/img/icons/plus.svg"
                            alt="img" class="me-1">Lưu banner quảng cáo</button>
                </div>
            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="select text-black" name="vitri">
                                            ...
                                            <option value="home_banner_promotion_1">Banner khuyến mãi bên trái</option>
                                            <option value="home_banner_promotion_2">Banner khuyến mãi ở giữa</option>
                                            <option value="home_banner_promotion_3">Banner khuyến mãi phải</option>
                                            <option value="home_banner_ads">Banner quảng cáo</option>
                                            <option value="home_banner_product">Banner giới thiệu sản phẩm</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Mô tả banner quảng cáo <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                class="text-danger" title="Bắt buộc">*</span></label>
                                        <textarea class="form-control" name="mota" value=""
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Trạng thái banner quảng cáo <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                class="text-danger" title="Bắt buộc">*</span></label>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label> Hình ảnh banner quảng cáo <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                class="text-danger" title="Bắt buộc">*</span></label>
