    ...
    <div class="page-wrapper">
      <form class="content" action="#" method="post" enctype="multipart/form-data">
        <div class="page-header">
          ...
          <div class="page-btn">
            <button type="submit" class="btn btn-added"><img src="{{asset('assets/admin')}}/img/icons/plus.svg" alt="img" class="me-1">Lưu danh mục</button>
          </div>
        </div>
                ...
                <div class="row">
                  <div class="col-lg-12 col-sm-6 col-12">
                    <div class="form-group">
                      ...
                      <input class="text-black" type="text" name="tendm" value="" placeholder="Nhập tên danh mục sản phẩm..."
