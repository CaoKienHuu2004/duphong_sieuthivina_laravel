...
@section('content')
    <div class="page-wrapper">
        <form class="content" action="{{ route('quan-tri-vien.luu-thuong-hieu') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="page-header">
                <div class="page-title">
                    <h4>Thêm thương hiệu sản phẩm</h4>
                    <h6>Thêm thông tin thương hiệu sản phẩm của bạn vào hệ thống</h6>
                </div>
                <div class="page-btn">
                    <button type="submit" class="btn btn-added"><img src="{{asset('assets/admin')}}/img/icons/plus.svg"
                            alt="img" class="me-1">Lưu thương hiệu</button>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Tên thương hiệu <span data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <input class="text-black" type="text" name="ten"
                                            ...
                                            onkeyup="ChangeToSlug();" value="{{ old('tenth') }}"/>
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Trạng thái thương hiệu <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                class="text-danger" title="Bắt buộc">*</span></label>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label> Hình ảnh thương hiệu <span data-bs-toggle="tooltip" data-bs-placement="top"
                                                class="text-danger" title="Bắt buộc">*</span></label>
