        ...
        <form class="content" action="{{ route('quan-tri-vien.luu-danh-muc') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="page-header">
                <div class="page-title">
                    ...
                    <h6>Thêm thông tin mã giảm giá của bạn vào hệ thống</h6>
                </div>
                <div class="page-btn">
                                ...
                                <div class="col-lg-12 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="text-black" type="text" name="magiamgia"
                                            placeholder="Nhập mã giảm giá..." value="{{ old('magiamgia') }}"/>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="text-black form-control" type="number" name="dieukien"
                                            placeholder="Nhập diều kiện giảm giá..." value="{{ old('dieukien') }}"/>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="text-black form-control" type="number" name="giatri"
                                            placeholder="Nhập giá trị giảm giá..." value="{{ old('giatri') }}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="text-black form-control" type="date" name="ngaybatdau"
                                            placeholder="Ngày bắt đầu..." value="{{ old('ngaybatdau') }}"/>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="text-black form-control" type="date" name="ngayketthuc"
                                            placeholder="Ngày ketthuc..." value="{{ old('ngayketthuc') }}"/>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-sm-6 col-12">
                                    <div class="form-group">
