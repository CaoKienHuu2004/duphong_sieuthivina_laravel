...
(30, 11, 25, 51000, 221, 0, 7513, 'Còn hàng', NULL),
...
(38, 19, 29, 340000, 16, 0, 3509, 'Còn hàng', NULL),
...
CREATE TABLE `chitiet_donhang` (
  ...
  `tenbienthe` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `chitiet_donhang` (`id`, `id_bienthe`, `id_donhang`, `tensanpham`, `tenbienthe`, `soluong`, `dongia`, `deleted_at`) VALUES
(54, 30, 33, 'Nước yến sào Nest100 lon 190ml - Hộp 5 lon', 'Có đường (190ml/lon)', 1, 51000, NULL),
(55, 38, 33, 'Cà phê bào tử Linh Chi phá vách – Giúp tỉnh táo', 'Loại thường (20 gói x 15g)', 1, 306000, NULL);
...
CREATE TABLE `donhang` (
  ...
  `nguoinhan` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `diachinhan` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `khuvucgiao` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `hinhthucvanchuyen` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `mavoucher` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `donhang` (`id`, `id_nguoidung`, `id_diachinguoidung`, `id_phivanchuyen`, `id_phuongthuc`, `id_magiamgia`, `madon`, `nguoinhan`, `diachinhan`, `khuvucgiao`, `hinhthucvanchuyen`, `phigiaohang`, `hinhthucthanhtoan`, `sodienthoai`, `mavoucher`, `giagiam`, `tamtinh`, `thanhtien`, `trangthaithanhtoan`, `trangthai`, `created_at`, `updated_at`, `deleted_at`) VALUES
(33, 3, 3, 1, 3, 2, 'STV25112833', 'Trần Bá Hộ', '801/2A Phạm Thế Hiển, Phường 4, Quận 8', 'Thành phố Hồ Chí Minh', 'Nội tỉnh (TP.HCM)', 0, 'Thanh toán qua QR Code', '0987654321', 'NEWSTORE50K', 50000, '357000', 307000, 'Đã thanh toán', 'Đang đóng gói', '2025-11-27 22:02:41', '2025-11-27 22:02:41', NULL);
...
(2, 'NEWSTORE50K', '50000', 'Giảm 50K cho tất cả khách hàng nhân dịp khai trương Siêu Thị Vina', 50000, '2025-11-06', '2025-12-31', 'Hoạt động', NULL);
...
(3, 'hotb', '$2y$12$HkN//sdXq/bdEO0ILo6URenzV0oJ4aupXqvjCU0jtqtfp1yRnhHkS', '0987654321', 'hotb@fpt.edu.vn', 'Trần Bá Hộ', 'Nam', '1981-03-24', 'hotb.jpg', 'admin', 'Hoạt động', NULL, '2hCci2QjWpUgbNMe5fxq5xx8Aog8Pl7CBlzYkiykqZBTiDmBUjvjMUAPdf1D'),
...
(6, 44, 1, '3', 1000000, 'Tặng 1 hộp quà tặng cao cấp từ NEST100 Ngũ Phúc Luxury', 'tang-1-hop-qua-tang-cao-cap-tu-nest100-ngu-phuc-luxury', 'Mua bộ 3 sản phẩm khác nhau từ cửa hàng thương hiệu NEST100, tặng 1 hộp quà tặng cao cấp Ngũ Phúc Luxury trị giá ~900.000 VNĐ nhân dịp gần đầu năm 2026', 'hop-qua-tang-cao-cap-ngu-phuc-luxury-to-yen-tinh-che-va-yen-chung-nest100-cao-cap-kem-tui-2.webp', 132, '2025-10-09', '2026-02-15', 'Hiển thị', NULL);
...
(25, 4, 'Nước yến sào Nest100 lon 190ml - Hộp 5 lon', 'nuoc-yen-sao-nest100-lon-190ml-hop-5-lon', 'Nước Yến Sào cao cấp NEST100 được sản xuất từ yến sào, chứa nhiều acid amin và nguyên tố vi lượng cần thiết giúp Giải khát và làm mát cơ thể an toàn. Tăng cường sức khỏe, giảm căng thẳng, mệt mỏi.', 'Việt Nam', 'Việt Nam', 'Công khai', 0, 164, NULL),
...
(29, 5, 'Cà phê bào tử Linh Chi phá vách – Giúp tỉnh táo', 'ca-phe-bao-tu-linh-chi-pha-vach-giup-tinh-tao', 'Thực phẩm bổ sung Lingzhi Coffee - Cà phê sức khỏe giúp tỉnh táo, hỗ trợ bảo vệ gan', 'Việt Nam', 'Việt Nam', 'Công khai', 10, 45, NULL),
...
(5, 3, 'Bạn đã đặt hàng thành công !', 'Mã đơn STV25112833 của bạn, vui lòng kiểm tra đơn hàng của bạn.', 'http://127.0.0.1:8000/don-hang/STV25112833', 'Đơn hàng', 'Đã đọc', '2025-11-27 22:02:41', '2025-11-28 05:51:51');
...
--
-- Table structure for table `trang_noidung`
--

CREATE TABLE `trang_noidung` (
  `id` int NOT NULL,
...
--
-- Indexes for table `trang_noidung`
--
ALTER TABLE `trang_noidung`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `trang_noidung`
--
ALTER TABLE `trang_noidung`
